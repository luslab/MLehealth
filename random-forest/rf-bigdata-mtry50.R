...
#' 
#' This attempt uses a larger mtry to try to improve performance. I'm concerned
#' that, given that presumably many of the variables aren't that informative,
#' that picking from 18 at a time leads to poor performance. Given that we're
#' including the original model data here, performance shouldn't get worse...but
#' it does! So maybe giving the forests more options (50, as a guess) will make
#' things a bit better?

output.base <- '../../output/rf-bigdata-try2'
